...
std::unordered_map<SvgTypes, std::string> AbstractBase::svgs {
        ...
        {SVG_INFO, "<svg fill=\"var(--notes-fg)\" width=\"14\" height=\"14\" class=\"centering\">\n"
                   "       <path\n"
                   "         d=\"m 7,10.50042 q 0.2973723,0 0.516621,-0.219249 0.2184088,-0.218408 0.2184088,-0.5157808 V 7.0176407 q 0,-0.2973719 -0.2184088,-0.5073803 Q 7.2973723,6.300252 7,6.300252 q -0.2973719,0 -0.5166207,0.2184087 -0.2184087,0.2192488 -0.2184087,0.5166207 v 2.7469097 q 0,0.2982119 0.2184087,0.5082199 Q 6.7026281,10.50042 7,10.50042 Z M 7,4.8822753 q 0.2973723,0 0.516621,-0.2184087 0.2184088,-0.2192488 0.2184088,-0.5166207 0,-0.2973719 -0.2184088,-0.5157806 Q 7.2973723,3.4122165 7,3.4122165 q -0.2973719,0 -0.5166207,0.2192488 -0.2184087,0.2184087 -0.2184087,0.5157806 0,0.2973719 0.2184087,0.5166207 Q 6.7026281,4.8822753 7,4.8822753 Z M 7,14 Q 5.5475819,14 4.2698908,13.448938 2.9921997,12.897876 2.0471619,11.952838 1.1021241,11.0078 0.55106205,9.7301094 0,8.4524177 0,7 0,5.5475819 0.55106205,4.2698908 1.1021241,2.9921997 2.0471619,2.0471619 2.9921997,1.1021241 4.2698908,0.55106205 5.5475819,0 7,0 8.4524177,0 9.7301094,0.55106205 11.0078,1.1021241 11.952838,2.0471619 12.897876,2.9921997 13.448938,4.2698908 14,5.5475819 14,7 14,8.4524177 13.448938,9.7301094 12.897876,11.0078 11.952838,11.952838 11.0078,12.897876 9.7301094,13.448938 8.4524177,14 7,14 Z M 7,7 Z m 0,5.529941 q 2.2924519,0 3.911197,-1.618744 Q 12.529941,9.2924519 12.529941,7 q 0,-2.2924517 -1.618744,-3.9111965 Q 9.2924519,1.4700588 7,1.4700588 q -2.2924517,0 -3.9111965,1.6187448 Q 1.4700588,4.7075483 1.4700588,7 q 0,2.2924519 1.6187448,3.911197 Q 4.7075483,12.529941 7,12.529941 Z\"\n"
                   "         id=\"path848\"\n"
                   "         style=\"stroke-width:0.840033\" /></svg>"},
        {SVG_WARNING, "<svg fill=\"var(--warnings-fg)\" width=\"15\" height=\"14\" class=\"centering\">\n"
                      "      <path\n"
                      "       d=\"M 7.5184413,7.4090119 Z M 0.78458508,14 q -0.4391454,0 -0.6675011,-0.409948 -0.229234,-0.409012 -0.00966,-0.818024 L 6.8412791,0.4090119 Q 7.0608518,0 7.4999972,0 7.9391426,0 8.1587153,0.4090119 L 14.892571,12.772028 q 0.219574,0.409012 -0.0096,0.818024 Q 14.654555,14 14.215409,14 Z M 7.5184413,5.4397647 q -0.310915,0 -0.5401489,0.244284 -0.2283556,0.243348 -0.2283556,0.5746757 V 8.442305 q 0,0.332264 0.2283556,0.575612 0.2292339,0.244284 0.5401489,0.244284 0.3109149,0 0.5392706,-0.244284 Q 8.2869458,8.774569 8.2869458,8.442305 V 6.2587244 q 0,-0.3313277 -0.2292339,-0.5746757 -0.2283557,-0.244284 -0.5392706,-0.244284 z m 0,6.2203503 q 0.3109149,0 0.5392706,-0.243348 0.2292339,-0.244284 0.2292339,-0.575612 0,-0.331327 -0.2292339,-0.575611 -0.2283557,-0.243349 -0.5392706,-0.243349 -0.310915,0 -0.5401489,0.243349 -0.2283556,0.244284 -0.2283556,0.575611 0,0.331328 0.2283556,0.575612 0.2292339,0.243348 0.5401489,0.243348 z M 2.1020215,12.36208 H 12.897973 L 7.4999972,2.4568793 Z\"\n"
                      "       id=\"path952\"\n"
                      "       style=\"stroke-width:0.906664\" /></svg>"}
};
...
void ArticleTag::generate_styles(std::string &s) {
    s += "  <script src=\"C:/Users/Dell/repos/nml/cmake-build-debug/MathJax-master/es5/tex-chtml-full.js\" id=\"MathJax-script1\" async></script>\n"
         ...
         "      --notes-fg: #1f6feb;\n"
         "      --notes-bg: rgba(56,139,253,0.15);\n"
         "      --warnings-bg: #ffb38033;\n"
         "      --warnings-fg: #cf5606;\n"
         "    }\n"
         "\n"
         "    .powderCracks {\n"
...
/*         "      white-space: nowrap;\n"
         ...
         "\n"
         "    .warnings {\n"
         "      background-color: var(--warnings-bg);\n"
         "      padding: 10px;\n"
         "      border-radius: 5px;\n"
         "      font-size: 14px;\n"
         "      margin-bottom: 20px;\n"
...
NotesTag::NotesTag(Parent parent)
    : AbstractBase{parent}
{
}

void NotesTag::generate(std::string &s, long long int indent) {
    auto in = std::string(indent*2, ' ');
    auto in1 = in + "  ";
    auto in2 = in1 + "  ";
    s += "<div class=\"notes\">\n"
         + in1 + "<span>\n"
         + in2 + svgs[SVG_INFO] + "</span><span class=\"note\"> Note:</span>\n"
         + in2 + "<span>\n";
...
WarningTag::WarningTag(Parent parent)
    : AbstractBase{parent}
{
}

void WarningTag::generate(std::string &s, long long int indent) {
    auto in = std::string(indent*2, ' ');
    auto in1 = in + "  ";
    auto in2 = in1 + "  ";
    s += "<div class=\"warnings\">\n"
         + in1 + "<span>\n"
         + in2 + svgs[SVG_WARNING] + "</span><span class=\"warning\"> Warning:</span>\n"
         + in2 + "<span>\n";
